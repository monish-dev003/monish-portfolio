...
const ROWS = [
  ...
  [
    { title: "Core Concepts", items: ["Component Architecture", "State Management", "API Integration", "Performance Optimization", "Responsive Design"] },
    { title: "Soft Skills",   items: ["Quick Learner", "Team Collaboration", "Adaptability", "Problem Solving", "Communication"] },
  ],
];

// ✅ H-08: debounce helper
...
export default function Skills() {
  ...
  // ✅ H-08: Position circles + resize listener
  const placeCircles = () => {
  ...
  useEffect(() => {
    ...
    circles.forEach((circle) => {
      ...
      circle.animate(
        ...
        { duration: 5000 + Math.random() * 3000, direction: "alternate", iterations: Infinity, easing: "ease-in-out" }
      );
    });

    // ✅ H-08: resize listener
    const onResize = debounce(placeCircles, 200);
  ...
  return (
    <section className="skills-container" id="skills">
      {/* Header — ✅ H-08: pink (#7b6fe8) → violet (#7b6fe8) */}
      <motion.div
      ...
      >
        <p style={{ fontSize: "0.85rem", color: "#4f8ef7", letterSpacing: "2px", textTransform: "uppercase", marginBottom: "0.5rem", fontWeight: "bold" }}>
          What I work with
        </p>
        <h2 style={{
          fontFamily: "'Syne', sans-serif",
          fontSize: "2.8rem",
          background: "linear-gradient(to right, #7b6fe8, #4f8ef7)", /* ✅ was #38bdf8→#7b6fe8 */
        ...
        <div style={{ width: 80, height: 3, background: "linear-gradient(to right, #7b6fe8, #4f8ef7)", margin: "12px auto", borderRadius: 2 }} />
      ...
      <motion.div
        ...
        style={{
          width: "100%", height: "550px", borderRadius: "30px",
          background: "radial-gradient(circle at center, rgba(123,111,232,0.07), #0a0a0c)",
          overflow: "hidden",
      ...
      >
        {SKILLS.map((s, i) => (
          <motion.div
            ...
            whileHover={{
              scale: 1.25,
              boxShadow: "0 0 40px rgba(123,111,232,0.35)",
          ...
          >
            <motion.img
              ...
              style={{ width: "42px", height: "42px", objectFit: "contain", filter: "drop-shadow(0 0 10px rgba(123,111,232,0.3)) brightness(1.1)", marginBottom: 6 }}
            />
            ...
            {row.map((col, colIndex) => (
              <motion.div
                ...
                whileHover={{
                  scale: 1.03,
                  borderColor: "#7b6fe8",
                  boxShadow: "0 10px 30px rgba(123,111,232,0.12)",
                }}
              ...
              >
                ...
                <ul style={{ listStyle: "none", padding: 0 }}>
                  {col.items.map((item, i) => (
                    <motion.li
                      key={i}
                      whileHover={{ x: 8, color: "#4f8ef7" }}
                      style={{ color: "#94a3b8", marginBottom: "8px", fontSize: "0.9rem" }}
                    >
                      <span style={{ color: "#7b6fe8", marginRight: "8px" }}>▹</span> {item}
                    </motion.li>
                  ))}
                </ul>
              </motion.div>
