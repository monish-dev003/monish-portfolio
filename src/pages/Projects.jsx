...
const PROJECTS = [
  {
    ...
    code: 'https://github.com/monish-dev003',
  },
  {
    title: '📝 Word Analyzer',
  ...
  },
  {
    ...
    live: 'https://ephemeral-stroopwafel-17a60a.netlify.app',
    code: 'https://github.com/monish-dev003',
  },
  {
    title: '🌐 Portfolio Website',
    desc: 'A modern, responsive developer portfolio built with React and Framer Motion. Features smooth animations, interactive skill visualization, and a clean dark aesthetic.',
    ss: '/portfolio.jpg',
    ...
    >
      <div style={{ maxWidth: '1200px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
        <div style={{ textAlign: 'center', marginBottom: '60px' }}>
          ...
          >
            🚀 <span style={{
              background: 'linear-gradient(90deg, #4f8ef7, #7b6fe8)',
              ...
              <div style={{ display: 'flex', gap: '12px' }}>
                <motion.a
                  ...
                  style={{
                    ...
                    background: 'rgba(255,255,255,0.05)', color: '#fff', padding: '10px', borderRadius: '12px',
                    fontSize: '0.85rem', border: '1px solid rgba(79,142,247,0.2)', textDecoration: 'none', fontWeight: 600,
                  }}
                >
                  <Github size={16} color="#38bdf8" /> Code
                </motion.a>
                ...
                <motion.a
                  ...
                  style={{
                    flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px',
                    background: 'linear-gradient(135deg, #4f8ef7, #7b6fe8)',
